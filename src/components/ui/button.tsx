  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-target",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-success-foreground hover:bg-success/90 hover:shadow-lg hover:scale-105 active:scale-95",
        info: "bg-info text-info-foreground hover:bg-info/90 hover:shadow-lg hover:scale-105 active:scale-95",
        premium: "primary-gradient text-white hover:shadow-glow hover:scale-105 active:scale-95 shadow-elegant",
        floating: "btn-float bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg",
      },
      size: {
